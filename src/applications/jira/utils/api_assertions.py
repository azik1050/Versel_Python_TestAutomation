...
from src.core.utils.allure import attach_and_raise_api_exception
...
class ApiAssertions:
    ...
    def assert_status_code(response: Response, expected_code: int):
        try:
            ...
            attach_and_raise_api_exception("Invalid Response Code", response, e)
    ...
    def validate_response_model(response: Response, expected_model: type[BaseModel]):
        try:
            ...
            attach_and_raise_api_exception("Invalid Response Body", response, e)
    ...
    def assert_key_value(response: Response, key: str | list, value: str):
        try:
            ...
            attach_and_raise_api_exception("Field Value Mismatch", response, e)
