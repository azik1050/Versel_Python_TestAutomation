...
class ApiClient:
    ...
    @__request_logging()
    def _request(self, path: str, method: str, json: dict | list[dict] | BaseModel = None, headers: dict = None, params: dict = None) -> Response:
        allure.attach(
    ...
    def post(self, path: str, json: dict | BaseModel | list[dict], **kwargs) -> Response:
